...
function TerminalPanel({ externalCommand, onExternalCommandHandled }) {
  ...
  const handleScrollbackClick = useCallback((e) => {
    // Focus input when clicking empty space in scrollback
    ...
    <div className="solvers-page">
      ...
      <main className="solvers-main">
        <div className="terminal-layout">
          {/* Retro terminal machine frame */}
          <div className="terminal-machine-frame">
            ...
            <div className="machine-power-led" aria-hidden="true" />
          </div>
